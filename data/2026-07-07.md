...
### [9] [Human-Centric Reflective Architecture for Human-AI Collaborative Decision-Making](https://arxiv.org/abs/2607.03025)
...
### [11] [Silicon Sampling via Cross-Survey Transfer](https://arxiv.org/abs/2607.03091)
...
### [12] [A Sliding-Window-Based Reinforcement Learning for Dynamic Assembly Flow Shop Scheduling with Multi-Product Delivery](https://arxiv.org/abs/2607.02941)
...
### [13] [Organizational Memory for Agentic Business Process Execution](https://arxiv.org/abs/2607.03228)
...
### [14] [Evaluating Generative Agents with Actions Grounded in Socially Distributed Task Environments using Incognita](https://arxiv.org/abs/2607.02975)
*Dan C. Hsu,Luke Lu*
...
### [15] [Agentic IoT: Architectures, Applications, and Challenges Toward the Internet of Agents](https://arxiv.org/abs/2607.04219)
...
### [16] [Reinforcement Learning for Evidence-Seeking Diagnostic Reasoning with Large Language Models](https://arxiv.org/abs/2607.02983)
...
### [18] [Beyond Forecasting: The Belief-to-Trade Layer in Prediction-Market Agents](https://arxiv.org/abs/2607.03015)
...
### [19] [LLM-as-a-Verifier: A General-Purpose Verification Framework](https://arxiv.org/abs/2607.05391)
...
### [59] [Agent Step Value: State-Transition Measurement with State-Grounded LLM Evaluators](https://arxiv.org/abs/2607.04419)
...
### [60] [ResearchStudio-Idea: An Evidence-Grounded Research-Ideation Skill Suite from ML Conference Outcomes](https://arxiv.org/abs/2607.04439)
...
### [61] [Why Pure Reasoning is Not Enough: Nature as the Source of Mathematical Innovation](https://arxiv.org/abs/2607.04505)
...
### [62] [Compressing the Validation Bottleneck: An Agentic Self-Driving Lab for Scientific Discovery](https://arxiv.org/abs/2607.04508)
...
### [63] [VLA Grounder: Language-Conditioning Space Optimization for Black-Box VLA Models](https://arxiv.org/abs/2607.04517)
...
### [64] [Measuring Harness-Induced Belief Divergence in Multi-Step LLM Agents](https://arxiv.org/abs/2607.04528)
...
### [65] [Heaviside Continuity of Rolling Coefficients for Eliminating Epistemic Entropy in Large Language Models](https://arxiv.org/abs/2607.04562)
...
### [66] [Detecting Answer-Driven Reasoning in LLM-Based Educational Tutors via Truncated Chain-of-Thought Auditing](https://arxiv.org/abs/2607.04572)
...
### [67] [Attention Limited Reward Learning](https://arxiv.org/abs/2607.04590)
*Wenqian Xing*
...
### [68] [Governed Individuation: Cryptographically Decoupling an Agent's Learning from Its Authority](https://arxiv.org/abs/2607.04613)
...
### [103] [GLM-5 Serving Parameter Tuning for OpenClaw: Single-Deployment MaaS Inference Optimization for Long-Context Agent Workloads](https://arxiv.org/abs/2607.02518)
...
### [104] [Kotlin-MP: DSL and IR Transformer for Parallelism](https://arxiv.org/abs/2607.02519)
*Ruikai Huang*
...
### [105] [Tile-Level Activation Overlap for Efficient LLM Inference](https://arxiv.org/abs/2607.02521)
...
### [106] [Multi-Turn Distributed Inference with Mixture of Experts for 6G Edge--Cloud Networks](https://arxiv.org/abs/2607.02522)
...
### [107] [Edge-Deployable LLM Fine-Tuning on a Single GPU for Telecom Network Troubleshooting](https://arxiv.org/abs/2607.02523)
...
### [108] [SWIFT: Spatio-temporal Wavelet Integrated Forecasting Framework for Workload Traces](https://arxiv.org/abs/2607.02524)
...
### [109] [PEEK: Predictive Queue-Informed KV Cache Management for LLM Serving](https://arxiv.org/abs/2607.02525)
...
### [110] [Operational Memory Architecture for Kubernetes: Evidence Horizon Taxonomy and Extended Causal Pattern Preservation](https://arxiv.org/abs/2607.02528)
*Shamsher Khan*
...
### [111] [RepliCore: Reproducible Parallel Simulation under Asynchronous Browser Runtimes](https://arxiv.org/abs/2607.02529)
*Anqing Chen*
...
### [112] [Static PTX Metrics Track Structural Kernel Regressions but Miss Semantic Ones](https://arxiv.org/abs/2607.02541)
*Dipankar Sarkar*
...
### [113] [ETALE: Evolving Topology with Accelerated Lock-free Execution for Dynamic Graph ANN Search on GPUs](https://arxiv.org/abs/2607.02543)
*Dongfang Zhao*
...
### [114] [A Workflow-Aware Serving Layer for Agentic Applications](https://arxiv.org/abs/2607.02942)
...
### [115] [Not Every Sync Is Safe: Calibrated DiLoCo Scheduling for Shared AI Infrastructure](https://arxiv.org/abs/2607.02544)
...
### [116] [MLSYSIM: First-Principles Infrastructure Modeling for Machine Learning Systems](https://arxiv.org/abs/2607.02558)
*Vijay Janapa Reddi*
...
### [117] [From Tensor Buffer to Distributed Memory Hierarchy: A Survey of KV Cache Management for LLM Serving](https://arxiv.org/abs/2607.02574)
...
### [118] [Scaling Weisfeiler-Leman Expressiveness Analysis to Massive Graphs with GPUs](https://arxiv.org/abs/2607.02603)
...
### [119] [Fine-Grained Computation Offload for Off-the-Shelf Servers in Tens of Lines](https://arxiv.org/abs/2607.02630)
*Bojie Li*
...
### [120] [Remora: Scale-out Deterministic Execution for Smart Contracts](https://arxiv.org/abs/2607.02817)
...
### [121] [Cassandra: Consensus with Partial Progress via Robust Partitionable View Synchronization](https://arxiv.org/abs/2607.02856)
...
### [122] [Agentic Orchestration of HPC Applications in Cloud](https://arxiv.org/abs/2607.02925)
...
### [123] [Cross-IP Request Coalescing: Relocating the Fan-out Point in Virtualized I/O](https://arxiv.org/abs/2607.02969)
...
### [124] [HyperParallel-Mpipe: A Composable Algebra System for Optimizing MLLM Training over Supernode Clusters](https://arxiv.org/abs/2607.03229)
...
### [125] [SPORK: Self-Speculative Forking to Accelerate Agentic LLM Inference](https://arxiv.org/abs/2607.03333)
...
### [126] [Scale-Free Beamforming using Swarm Arrays for Remote Sensing under Interference](https://arxiv.org/abs/2607.03499)
...
### [127] [BrownoutMoE: Structure-Aware Expert Grouping for Efficient and Accurate LLM Web-based Services](https://arxiv.org/abs/2607.04164)
...
### [128] [CoCoScale: Leveraging Layer-wise Scaling to Unlock the Potential of Online LLM Serving](https://arxiv.org/abs/2607.04181)
...
### [129] [Sangam: Efficiently Serving Diffusion LLMs with the AR Stack](https://arxiv.org/abs/2607.04206)
...
### [130] [Air-Plan: Query-Optimized Topology Selection for Over-the-Air Decentralized Federated Learning](https://arxiv.org/abs/2607.04254)
...
### [131] [GORIO: GPU-Centered Remote I/O for Graph ANNS over NVMe-oF](https://arxiv.org/abs/2607.04415)
*Gen Zhang,Wenhao Gu*
...
### [132] [Adaptive Space-efficient Collectives for Dynamic and Unstructured Sparsity on GPU Platforms](https://arxiv.org/abs/2607.04676)
...
### [133] [Direct Model State Migration for Elastic Training of Large Language Models](https://arxiv.org/abs/2607.04749)
...
### [134] [Orcaella: Hybrid Fault Tolerance with Client-Selectable Finality Latency](https://arxiv.org/abs/2607.04789)
...
### [135] [Performance evaluation of scheduling tasks in many-core systems utilizing processes and threads](https://arxiv.org/abs/2607.04821)
...
### [136] [No Distributed Quantum Advantage for 3-Coloring Rooted Trees and 2-Coloring Even Cycles](https://arxiv.org/abs/2607.04852)
...
### [137] [Symmetry all the way down](https://arxiv.org/abs/2607.04887)
...
### [138] [TARE: Tail Aware Evaluation of HPC Job Runtime Prediction](https://arxiv.org/abs/2607.04935)
...
### [139] [When Words Predict Workload](https://arxiv.org/abs/2607.04951)
*Anubhab Banerjee*
...
### [140] [Communication-Aware Placement and Pruning for Efficient Mixture-of-Experts Inference](https://arxiv.org/abs/2607.05116)
...
### [141] [CATs: Secure Blockchain Interoperability with Cross-chain Atomic Transactions](https://arxiv.org/abs/2607.05387)
